...
const CSS_TOPICS_CATALOG = [
    { id: 'what-is-css', title: 'What is CSS?', category: 'Basics' },
    { id: 'css-syntax', title: 'CSS Syntax & Rule Anatomy', category: 'Basics' },
    { id: 'ways-to-add-css', title: '3 Ways to Add CSS', category: 'Basics' },
    { id: 'element-selectors', title: 'Element Selectors', category: 'Selectors' },
    { id: 'class-selectors', title: 'Class Selectors (.class)', category: 'Selectors' },
    { id: 'id-selectors', title: 'ID Selectors (#id)', category: 'Selectors' },
    { id: 'grouping-selectors', title: 'Grouping & Universal Selectors', category: 'Selectors' },
    { id: 'combinators', title: 'CSS Combinators', category: 'Selectors' },
    { id: 'specificity', title: 'CSS Specificity & The Cascade', category: 'Selectors' },
    { id: 'inheritance', title: 'CSS Inheritance', category: 'Selectors' },
    { id: 'colors', title: 'Colors in CSS', category: 'Colors & Units' },
    { id: 'css-units', title: 'CSS Units (px, rem, em, vh, vw)', category: 'Colors & Units' },
    { id: 'font-properties', title: 'Font Properties', category: 'Typography' },
    { id: 'text-properties', title: 'Text Styling Properties', category: 'Typography' },
    { id: 'web-fonts', title: 'Web Fonts (Google Fonts)', category: 'Typography' },
    { id: 'css-box-model', title: 'The CSS Box Model', category: 'Box Model' },
    { id: 'box-sizing', title: 'box-sizing Property', category: 'Box Model' },
    { id: 'margin', title: 'Margin & Margin Collapsing', category: 'Box Model' },
    { id: 'padding', title: 'Padding', category: 'Box Model' },
    { id: 'borders', title: 'Borders & border-radius', category: 'Box Model' },
    { id: 'width-and-height', title: 'Width, Height & Constraints', category: 'Box Model' },
    { id: 'backgrounds', title: 'CSS Backgrounds', category: 'Backgrounds' },
    { id: 'gradients', title: 'CSS Gradients', category: 'Backgrounds' },
    { id: 'shadows', title: 'Box Shadow & Text Shadow', category: 'Backgrounds' },
    { id: 'display', title: 'The display Property', category: 'Layout' },
    { id: 'position', title: 'CSS Positioning (relative, absolute, fixed, sticky)', category: 'Layout' },
    { id: 'z-index', title: 'z-index & Stacking Context', category: 'Layout' },
    { id: 'overflow', title: 'The overflow Property', category: 'Layout' },
    { id: 'flexbox-introduction', title: 'Flexbox Introduction', category: 'Flexbox' },
    { id: 'justify-content-align-items', title: 'justify-content & align-items', category: 'Flexbox' },
    { id: 'flex-direction-wrap-gap', title: 'flex-direction, flex-wrap & gap', category: 'Flexbox' },
    { id: 'grid-introduction', title: 'CSS Grid Introduction', category: 'CSS Grid' },
    { id: 'grid-template-columns', title: 'Grid Columns, Rows & minmax()', category: 'CSS Grid' },
    { id: 'grid-placement', title: 'Grid Item Placement & Areas', category: 'CSS Grid' },
    { id: 'responsive-design', title: 'Responsive Design Principles', category: 'Responsive' },
    { id: 'media-queries', title: 'CSS Media Queries & Breakpoints', category: 'Responsive' },
    { id: 'pseudo-classes', title: 'Pseudo-classes (:hover, :focus, :nth-child)', category: 'Advanced' },
    { id: 'pseudo-elements', title: 'Pseudo-elements (::before, ::after)', category: 'Advanced' },
    { id: 'transitions', title: 'CSS Transitions', category: 'Transitions' },
    { id: 'transform', title: 'CSS Transforms (2D & 3D)', category: 'Transforms' },
    { id: 'css-animations', title: 'CSS Keyframe Animations', category: 'Animations' },
    { id: 'css-variables', title: 'CSS Custom Properties (Variables)', category: 'Modern CSS' },
    { id: 'css-functions', title: 'Modern CSS Functions (calc, clamp, min, max)', category: 'Modern CSS' },
    { id: 'advanced-selectors', title: 'Advanced Selectors (:has, :is, :where)', category: 'Modern CSS' },
    { id: 'styling-buttons', title: 'Practical Component: Buttons', category: 'Components' },
    { id: 'styling-forms', title: 'Practical Component: Modern Form', category: 'Components' },
    { id: 'navbar-project', title: 'Mini-Project: Responsive Navbar', category: 'Projects' },
    { id: 'card-project', title: 'Mini-Project: Pricing / Product Cards', category: 'Projects' },
    { id: 'capstone-project', title: 'Capstone Project: Responsive Landing Page', category: 'Projects' }
];
