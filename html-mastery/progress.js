...
class StudentProgressSystem {
    constructor() {
        ...
        this.cssTopics = [
            { id: 'what-is-css', title: 'What is CSS?', url: 'css.html?topic=what-is-css' },
            { id: 'syntax', title: 'CSS Syntax', url: 'css.html?topic=syntax' },
            { id: 'selectors', title: 'Basic Selectors', url: 'css.html?topic=selectors' },
            { id: 'combinators', title: 'Combinators', url: 'css.html?topic=combinators' },
            { id: 'specificity', title: 'Specificity', url: 'css.html?topic=specificity' },
            { id: 'inheritance', title: 'Inheritance', url: 'css.html?topic=inheritance' },
            { id: 'colors', title: 'CSS Colors', url: 'css.html?topic=colors' },
            { id: 'units', title: 'CSS Units', url: 'css.html?topic=units' },
            { id: 'typography', title: 'Typography', url: 'css.html?topic=typography' },
            { id: 'text', title: 'Text Formatting', url: 'css.html?topic=text' },
            { id: 'backgrounds', title: 'Backgrounds', url: 'css.html?topic=backgrounds' },
            { id: 'borders', title: 'Borders & Outlines', url: 'css.html?topic=borders' },
            { id: 'box-model', title: 'The Box Model', url: 'css.html?topic=box-model' },
            { id: 'margin', title: 'Margin & Collapse', url: 'css.html?topic=margin' },
            { id: 'padding', title: 'Padding Inner Space', url: 'css.html?topic=padding' },
            { id: 'width-height', title: 'Sizing Dimensions', url: 'css.html?topic=width-height' },
            { id: 'display', title: 'Display Property', url: 'css.html?topic=display' },
            { id: 'position', title: 'Positioning Modes', url: 'css.html?topic=position' },
            { id: 'z-index', title: 'Stacking Context', url: 'css.html?topic=z-index' },
            { id: 'overflow', title: 'Container Overflow', url: 'css.html?topic=overflow' },
            { id: 'flexbox', title: 'CSS Flexbox', url: 'css.html?topic=flexbox' },
            { id: 'grid', title: 'CSS Grid Layout', url: 'css.html?topic=grid' },
            { id: 'responsive-design', title: 'Responsive Design', url: 'css.html?topic=responsive-design' },
            { id: 'media-queries', title: 'Media Queries', url: 'css.html?topic=media-queries' },
            { id: 'pseudo-classes', title: 'Pseudo-classes', url: 'css.html?topic=pseudo-classes' },
            { id: 'pseudo-elements', title: 'Pseudo-elements', url: 'css.html?topic=pseudo-elements' },
            { id: 'transitions', title: 'CSS Transitions', url: 'css.html?topic=transitions' },
            { id: 'transforms', title: '2D & 3D Transforms', url: 'css.html?topic=transforms' },
            { id: 'animations', title: 'Keyframe Animations', url: 'css.html?topic=animations' },
            { id: 'css-variables', title: 'CSS Custom Variables', url: 'css.html?topic=css-variables' },
            { id: 'css-functions', title: 'CSS Functions', url: 'css.html?topic=css-functions' },
            { id: 'advanced-selectors', title: 'Advanced Selectors', url: 'css.html?topic=advanced-selectors' },
            { id: 'mini-projects', title: 'CSS Practice Projects', url: 'css.html?topic=mini-projects' }
        ];
    ...
    checkBadges() {
        ...
        const badgeConditions = [
            ...
            { id: 'box_model_master', cond: this.data.completedLessons.includes('box-model') || this.data.completedExercises.some(ex => ex.includes('box')) },
            { id: 'flexbox_explorer', cond: this.data.completedLessons.includes('flexbox') || this.data.completedExercises.some(ex => ex.includes('flex')) },
            { id: 'grid_master', cond: this.data.completedLessons.includes('grid') || this.data.completedExercises.some(ex => ex.includes('grid')) },
            ...
            { id: 'project_builder', cond: this.data.completedLessons.includes('practice-project') || this.data.completedLessons.includes('mini-projects') || this.data.completedProjects.length >= 1 }
        ];
